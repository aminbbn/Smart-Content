    ...
    return (
        <div className="space-y-8 animate-page-enter w-full">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-slate-200/60 pb-6">
                <div>
                    <h2 className="text-3xl font-extrabold text-slate-800 tracking-tight">Research & Writer Agent</h2>
                    <p className="text-slate-500 mt-2 text-lg">Deep research and specialized article writing with selected writer</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div className="lg:col-span-5 sticky top-8">
                    ...
                    <div className="bg-white rounded-[2rem] shadow-card border border-slate-100 p-8 relative group">
                        ...
                        <form onSubmit={handleStart} className="space-y-6 relative z-10">
                            <div>
                                <label className="block text-sm font-bold text-slate-700 mb-2">Research & Writing Topic</label>
                                <textarea 
                                    required
                                    ...
                                    placeholder="e.g. Impact of Generative AI on future software development..."
                                    value={prompt}
                            ...
                            <div>
                                <label className="block text-sm font-bold text-slate-700 mb-2">Responsible Writer</label>
                                <WriterSelector 
                                    writers={writers}
                            ...
                            >
                                {loading ? (
                                    ...
                                    <>
                                        ...
                                        <span>Start Research Process</span>
                                    </>
                                )}
                            </button>
                        </form>
                ...
                <div className="lg:col-span-7 space-y-6">
                    <div className="flex items-center gap-3 mb-2">
                        <h3 className="font-bold text-slate-800 text-xl">Active Missions</h3>
                    ...
                    {tasks.length === 0 ? (
                        <div className="bg-white rounded-[2.5rem] border-2 border-dashed border-slate-200 p-16 flex flex-col items-center justify-center text-center">
                            ...
                            <p className="text-slate-500 font-bold">No research tasks yet</p>
                        </div>
                    ) : (
                                ...
                                return (
                                    <div key={task.id} className={`bg-white rounded-2xl shadow-sm border border-slate-100 p-6 animate-card-enter stagger-${index % 5} hover:shadow-md transition-shadow`}>
                                        ...
                                        <div className="bg-slate-50 rounded-xl p-4 text-xs text-slate-600 font-mono h-32 overflow-y-auto custom-scrollbar border border-slate-200/50">
                                            ...
                                            {results.logs?.length === 0 && <span className="text-slate-400">Waiting to start...</span>}
                                        </div>
                                    </div>
                                );
                            })}
